...
**Synced from:** openehr-assistant-mcp v0.18.0 (`resources/examples/archetypes/`). When the plugin bumps MCP compatibility, diff this directory against the MCP's `resources/examples/archetypes/` and sync any changed files — then update this header. See `CONTRIBUTING.md` → "Syncing bundled examples".
