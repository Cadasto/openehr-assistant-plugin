...
**Synced from:** openehr-assistant-mcp v0.20.0 (`resources/examples/archetypes/` — byte-identical to v0.18.0, verified at the v0.20.0 bump). When the plugin bumps MCP compatibility, diff this directory against the MCP's `resources/examples/archetypes/` and sync any changed files — then update this header. See `CONTRIBUTING.md` → "Syncing bundled examples".
