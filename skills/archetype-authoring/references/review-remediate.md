...
## 2. Lint
Apply the 22 normative lint rules — load `guide_get("openehr://guides/archetypes/rules")` for the definitions (the `archetype-lint` skill runs this standalone). Also load:
